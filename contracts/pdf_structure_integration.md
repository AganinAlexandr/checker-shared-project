...
5. Основной precision-инструмент для text-pillar - позиция и непрерывность: содержанием считается раннейший contiguous-кластер PP87-плотных страниц. Более поздние PP87-плотные BODY-страницы не должны выигрывать только из-за похожей компактности.
...
8. Компактность/плотность остается слабым дополнительным сигналом, но не основным precision-gate, потому что BODY-страницы с заголовком и data-таблицей могут структурно напоминать содержание.
