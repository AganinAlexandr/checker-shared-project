...
| TSK-007 | Шаг 1.2 | Поиск и отсечение титульной зоны | review | opus | `opus_checker@2f096bc:title_zone.py`, ГОСТ Р 21.101-2020 | Детектор: якорь титула (форма 12) = standalone «ПРОЕКТНАЯ ДОКУМЕНТАЦИЯ»+«Раздел» (чистый разделитель cover 64/81 vs контент 0/34; плотность/штамп НЕ годятся) + поглощение пустых разделителей. **cover_end exact 100%, ±1 100% на 34 resolved taxonomy, ложных аномалий 0.** Число титулов не хардкодим (1/2/4: XML/бумага/субподряд; обложка форма14 условна, ГОСТ 8.1.2). Аномалии displaced/missing → замечание ГОСТ. Кросс-проект: `title_pages_by_crc.csv` (451 bundle, high 443/low 8) для DocSpectrum (join по crc32). Остаток: интеграция cover_end в пайплайн + 8 low (РД/под-книги?) |
